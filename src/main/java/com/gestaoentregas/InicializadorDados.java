...
public class InicializadorDados implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        e3.addProduto(p2);
        e3.addProduto(p3);
        Motorista m1 = new Motorista("João", "81999999999", "1218931292", "1", 29);
        Motorista m2 = new Motorista("Marcelo", "89218219", "1231243266", "2", 19);
        Motorista m3 = new Motorista("Lucas", "81940028922", "99320199430", "3", 23);
        m1.setIdMotorista(1);
        m2.setIdMotorista(2);
        m3.setIdMotorista(3);
